...
export const strings = {
  zh: {
    ...
    setSecAbout: '关于',
    setSecSystem: '本机信息',
    setSysComputerName: '电脑名称',
    setSysHostname: '主机名',
    setSysOs: '操作系统',
    setSysArch: '架构',
    setSysUser: '系统用户',
    setSysHome: '主目录',
    setSysAppVersion: '应用版本',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: '系统语言',
    setSysCpu: '处理器',
    setSysMemory: '内存',
    setSysCores: '{n} 核',
    setSysCopyAll: '复制全部',
    setSecProxy: '网络代理',
    setProxyDesc: '为企业网络配置 HTTP 代理。用户名默认取自本机系统用户，密码仅保存在本机。',
    setProxyEnabled: '启用代理',
    setProxyEnabledDesc: '保存后立即用于本应用主进程的出站 HTTP(S)（AI、博查搜索等）。',
    setProxyUsername: '用户名',
    setProxyUsernameHint: '默认使用本机系统用户，可按需修改。',
    setProxyPassword: '密码',
    setProxyPasswordHint: '密码不会写入代码仓库，也绝不会被记录到日志。',
    setProxyHost: '主机',
    setProxyPort: '端口',
    setProxyUrl: '代理地址',
    setProxyUrlEmpty: '填写用户名和密码后生成',
    setProxyTestNeedCreds: '请先填写用户名和密码',
    setProxyTestOk: '代理可用',
    setProxyTestFail: '代理不可用',
    setProxyPlaintextWarn: '本机无法使用系统密钥链，密码将以明文保存在用户数据目录。',
    setSecIntegrations: '集成',
    intgHeroTitle: '在 AI 助手里使用 AI Office',
    intgHeroDesc:
    ...
    intgStep1Update: 'AI Office 升级带来新版 skill 时，对应助手旁会出现「更新」按钮。',
    ...
    intgOtherFolderDesc: '选择它的 skills 目录，AI Office 把文件写进去。',
    ...
    intgExample3: '把 budget.xlsx 转成 PDF，并在 AI Office 里打开',
    ...
    intgMcpPartDesc:
      'MCP 是 AI 助手调用外部工具的通用协议。助手不能运行命令（如 Claude Desktop），或你想让它直接操作 AI Office 窗口时用这条路。下面两种接法任选一种。',
    intgMcpStdioTitle: '由助手启动（推荐）',
    intgMcpStdioDesc:
      '助手自己拉起 genoffice mcp，不需要在这里开任何开关，AI Office 也不用开着。功能与 CLI 完全相同。',
    intgMcpHttpTitle: '本地 HTTP 服务',
    intgMcpHttpDesc:
      '在 AI Office 内运行，助手通过网址连接，可以看着它在 Word 编辑器里逐步生成。需要 AI Office 保持打开；目前只支持 Word。',
    intgMcpHttpAdvanced: '高级：其他地址与日志',
    intgMcpTryNote: '助手会通过 MCP 调用 AI Office，你不需要输入任何命令。',
    ...
    intgCopied: '已复制',
    intgCliEphemeral: '请先把 AI Office 拖到「应用程序」，再使用命令行。',
    intgCopyPath: '复制路径',
    intgCliNeedsUpdate: '此 skill 需要命令行 {v} 或更新版本，请更新 AI Office。',
    intgLoading: '正在检测…',
    ...
    starPromptTitle: '喜欢 AI Office 吗？',
    starPromptTitleN: '你已经用 AI Office 打开了 {n} 个文档',
    starPromptBody: 'AI Office 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 AI Office，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 AI Office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'AI Office 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
  ...
  en: {
    ...
    setSecAbout: 'About',
    setSecSystem: 'This computer',
    setSysComputerName: 'Computer name',
    setSysHostname: 'Hostname',
    setSysOs: 'Operating system',
    setSysArch: 'Architecture',
    setSysUser: 'System user',
    setSysHome: 'Home directory',
    setSysAppVersion: 'App version',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'System locale',
    setSysCpu: 'Processor',
    setSysMemory: 'Memory',
    setSysCores: '{n} cores',
    setSysCopyAll: 'Copy all',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Configure the corporate HTTP proxy. Username defaults to this computer’s system user. The password stays on this machine.',
    setProxyEnabled: 'Enable proxy',
    setProxyEnabledDesc:
      'After saving, applies immediately to this app’s main-process outbound HTTP(S) (AI, Bocha search, and similar).',
    setProxyUsername: 'Username',
    setProxyUsernameHint: 'Filled from this computer’s system user. You can change it if needed.',
    setProxyPassword: 'Password',
    setProxyPasswordHint: 'Never committed to git and never written to logs.',
    setProxyHost: 'Host',
    setProxyPort: 'Port',
    setProxyUrl: 'Proxy URL',
    setProxyUrlEmpty: 'Generated after username and password are entered',
    setProxyTestNeedCreds: 'Enter a username and password first',
    setProxyTestOk: 'Proxy reachable',
    setProxyTestFail: 'Proxy unreachable',
    setProxyPlaintextWarn:
      'OS encryption is unavailable; the password is stored in plaintext under the app userData folder.',
    setSecIntegrations: 'Integrations',
    intgHeroTitle: 'Use AI Office from your AI assistant',
    intgHeroDesc:
    ...
    intgStep1Update:
      'When a AI Office update ships a newer skill, an Update button appears next to that assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pick its skills folder and AI Office writes the file there.',
    ...
    intgExample3: 'Convert budget.xlsx to PDF and open it in AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is the common protocol AI assistants use to call external tools. Use it when your assistant cannot run commands (Claude Desktop, for example) or when you want it to drive the AI Office window directly. Pick either of the two ways below.',
    intgMcpStdioTitle: 'Started by the assistant (recommended)',
    intgMcpStdioDesc:
      'The assistant launches genoffice mcp itself: nothing to switch on here, and AI Office does not need to be open. Same features as the CLI.',
    intgMcpHttpTitle: 'Local HTTP server',
    intgMcpHttpDesc:
      'Runs inside AI Office; the assistant connects to a URL and you can watch it build the document step by step in the Word editor. AI Office must stay open; Word documents only for now.',
    intgMcpHttpAdvanced: 'Advanced: other endpoints and log',
    intgMcpTryNote: 'The assistant calls AI Office through MCP; you never type a command.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copied',
    intgCliEphemeral: 'Drag AI Office into Applications first, then use the command line.',
    intgCopyPath: 'Copy path',
    intgCliNeedsUpdate: 'This skill needs command line {v} or newer; update AI Office.',
    ...
    starPromptTitle: 'Enjoying AI Office?',
    starPromptTitleN: "You've opened {n} documents with AI Office",
    starPromptBody:
      'AI Office is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like AI Office, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to AI Office',
    ...
    onbBody2:
      'AI Office is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
  ...
  ja: {
    ...
    setSecAbout: '情報',
    setSecSystem: 'このコンピュータ',
    setSysComputerName: 'コンピュータ名',
    setSysHostname: 'ホスト名',
    setSysOs: 'オペレーティングシステム',
    setSysArch: 'アーキテクチャ',
    setSysUser: 'システムユーザー',
    setSysHome: 'ホームディレクトリ',
    setSysAppVersion: 'アプリのバージョン',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'システムの言語',
    setSysCpu: 'プロセッサ',
    setSysMemory: 'メモリ',
    setSysCores: '{n} コア',
    setSysCopyAll: 'すべてコピー',
    setSecProxy: 'プロキシ',
    setProxyDesc:
      '社内 HTTP プロキシを設定します。ユーザー名は本機のシステムユーザーが初期値です。パスワードはこのパソコンにのみ保存されます。',
    setProxyEnabled: 'プロキシを有効にする',
    setProxyEnabledDesc:
      '保存すると、このアプリのメインプロセスからの HTTP(S) 通信（AI、Bocha 検索など）にすぐ適用されます。',
    setProxyUsername: 'ユーザー名',
    setProxyUsernameHint: '本機のシステムユーザーが初期値です。必要なら変更できます。',
    setProxyPassword: 'パスワード',
    setProxyPasswordHint: 'Git には保存されず、ログにも出力されません。',
    setProxyHost: 'ホスト',
    setProxyPort: 'ポート',
    setProxyUrl: 'プロキシ URL',
    setProxyUrlEmpty: 'ユーザー名とパスワードを入力すると生成されます',
    setProxyTestNeedCreds: '先にユーザー名とパスワードを入力してください',
    setProxyTestOk: 'プロキシに接続できました',
    setProxyTestFail: 'プロキシに接続できません',
    setProxyPlaintextWarn:
      'OS の暗号化が使えないため、パスワードはユーザーデータフォルダに平文で保存されます。',
    setSecIntegrations: '連携',
    intgHeroTitle: 'AI アシスタントから AI Office を使う',
    intgHeroDesc:
    ...
    intgStep1Update:
      'AI Office の更新で新しいスキルが届くと、そのアシスタントの横に「更新」ボタンが表示されます。',
    ...
    intgOtherFolderDesc: 'その skills フォルダーを選ぶと、AI Office がファイルを書き込みます。',
    ...
    intgExample3: 'budget.xlsx を PDF に変換して AI Office で開いて',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP は AI アシスタントが外部ツールを呼び出すための共通プロトコルです。アシスタントがコマンドを実行できない場合（Claude Desktop など）や、AI Office のウィンドウを直接操作させたい場合に使います。下の 2 つの方法からどちらか 1 つを選んでください。',
    intgMcpStdioTitle: 'アシスタントが起動する（推奨）',
    intgMcpStdioDesc:
      'アシスタントが genoffice mcp を自分で起動します。ここで何かをオンにする必要はなく、AI Office を開いておく必要もありません。機能は CLI と同じです。',
    intgMcpHttpTitle: 'ローカル HTTP サーバー',
    intgMcpHttpDesc:
      'AI Office 内で動作し、アシスタントは URL で接続します。Word エディター上で文書が段階的に生成される様子を見られます。AI Office を開いたままにする必要があり、現時点では Word のみ対応です。',
    intgMcpHttpAdvanced: '詳細：その他のエンドポイントとログ',
    intgMcpTryNote:
      'アシスタントが MCP 経由で AI Office を呼び出します。コマンドを入力する必要はありません。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'コピーしました',
    intgCliEphemeral:
      '先に AI Office を「アプリケーション」に移してから、コマンドラインを使ってください。',
    intgCopyPath: 'パスをコピー',
    intgCliNeedsUpdate:
      'このスキルにはコマンドライン {v} 以降が必要です。AI Office を更新してください。',
    intgLoading: '確認中…',
    ...
    starPromptTitle: 'AI Office はいかがですか？',
    starPromptTitleN: 'AI Office で {n} 件のドキュメントを開きました',
    starPromptBody:
      'AI Office は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'AI Office が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    setSecAbout: '정보',
    setSecSystem: '이 컴퓨터',
    setSysComputerName: '컴퓨터 이름',
    setSysHostname: '호스트 이름',
    setSysOs: '운영 체제',
    setSysArch: '아키텍처',
    setSysUser: '시스템 사용자',
    setSysHome: '홈 디렉터리',
    setSysAppVersion: '앱 버전',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: '시스템 언어',
    setSysCpu: '프로세서',
    ...
    setSecProxy: '프록시',
    setProxyDesc:
      '회사 HTTP 프록시를 설정합니다. 사용자 이름은 이 컴퓨터의 시스템 사용자가 기본값입니다. 비밀번호는 이 기기에만 저장됩니다.',
    setProxyEnabled: '프록시 사용',
    setProxyEnabledDesc:
      '저장하면 이 앱 메인 프로세스의 아웃바운드 HTTP(S)(AI, Bocha 검색 등)에 바로 적용됩니다.',
    setProxyUsername: '사용자 이름',
    setProxyUsernameHint: '이 컴퓨터의 시스템 사용자가 기본값입니다. 필요하면 바꿀 수 있습니다.',
    setProxyPassword: '비밀번호',
    setProxyPasswordHint: 'Git에 커밋되지 않으며 로그에도 기록되지 않습니다.',
    setProxyHost: '호스트',
    setProxyPort: '포트',
    setProxyUrl: '프록시 URL',
    setProxyUrlEmpty: '사용자 이름과 비밀번호를 입력하면 생성됩니다',
    setProxyTestNeedCreds: '먼저 사용자 이름과 비밀번호를 입력하세요',
    setProxyTestOk: '프록시에 연결됨',
    setProxyTestFail: '프록시에 연결할 수 없음',
    setProxyPlaintextWarn:
      'OS 암호화를 사용할 수 없어 비밀번호가 앱 userData 폴더에 평문으로 저장됩니다.',
    setSecIntegrations: '연동',
    intgHeroTitle: 'AI 어시스턴트에서 AI Office 사용하기',
    intgHeroDesc:
    ...
    intgStep1Update:
      'AI Office 업데이트에 새 스킬이 포함되면 해당 어시스턴트 옆에 업데이트 버튼이 나타납니다.',
    ...
    intgOtherFolderDesc: '해당 skills 폴더를 선택하면 AI Office가 파일을 기록합니다.',
    ...
    intgExample3: 'budget.xlsx를 PDF로 변환해서 AI Office에서 열어 줘',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP는 AI 어시스턴트가 외부 도구를 호출하는 공통 프로토콜입니다. 어시스턴트가 명령을 실행할 수 없거나(예: Claude Desktop) AI Office 창을 직접 조작하게 하려면 이 방식을 사용하세요. 아래 두 방법 중 하나를 선택하면 됩니다.',
    intgMcpStdioTitle: '어시스턴트가 실행(권장)',
    intgMcpStdioDesc:
      '어시스턴트가 genoffice mcp를 직접 실행합니다. 여기서 켤 것이 없고 AI Office가 열려 있을 필요도 없습니다. 기능은 CLI와 같습니다.',
    intgMcpHttpTitle: '로컬 HTTP 서버',
    intgMcpHttpDesc:
      'AI Office 안에서 실행되며 어시스턴트가 URL로 연결합니다. Word 편집기에서 문서가 단계별로 만들어지는 과정을 볼 수 있습니다. AI Office를 열어 두어야 하며 현재는 Word만 지원합니다.',
    intgMcpHttpAdvanced: '고급: 기타 주소와 로그',
    intgMcpTryNote:
      '어시스턴트가 MCP를 통해 AI Office를 호출합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: '복사됨',
    intgCliEphemeral: '먼저 AI Office를 응용 프로그램 폴더로 옮긴 뒤 명령줄을 사용하세요.',
    intgCopyPath: '경로 복사',
    intgCliNeedsUpdate: '이 스킬은 명령줄 {v} 이상이 필요합니다. AI Office를 업데이트하세요.',
    intgLoading: '확인 중…',
    ...
    starPromptTitle: 'AI Office가 마음에 드시나요?',
    starPromptTitleN: 'AI Office로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'AI Office는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'AI Office가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    setSecSystem: 'Cet ordinateur',
    setSysComputerName: 'Nom de l’ordinateur',
    setSysHostname: 'Nom d’hôte',
    setSysOs: 'Système d’exploitation',
    setSysArch: 'Architecture',
    setSysUser: 'Utilisateur système',
    setSysHome: 'Dossier personnel',
    setSysAppVersion: 'Version de l’application',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Langue du système',
    setSysCpu: 'Processeur',
    setSysMemory: 'Mémoire',
    setSysCores: '{n} cœurs',
    setSysCopyAll: 'Tout copier',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Configurer le proxy HTTP d’entreprise. Le nom d’utilisateur est celui du compte système de cet ordinateur. Le mot de passe reste sur cette machine.',
    setProxyEnabled: 'Activer le proxy',
    setProxyEnabledDesc:
      'Après enregistrement, s’applique immédiatement au HTTP(S) sortant du processus principal (IA, recherche Bocha, etc.).',
    setProxyUsername: 'Nom d’utilisateur',
    setProxyUsernameHint:
      'Prérempli avec l’utilisateur système de cet ordinateur. Modifiable si besoin.',
    setProxyPassword: 'Mot de passe',
    setProxyPasswordHint: 'Jamais enregistré dans git ni écrit dans les journaux.',
    setProxyHost: 'Hôte',
    setProxyPort: 'Port',
    setProxyUrl: 'URL du proxy',
    setProxyUrlEmpty: 'Générée après saisie du nom d’utilisateur et du mot de passe',
    setProxyTestNeedCreds: 'Saisissez d’abord un nom d’utilisateur et un mot de passe',
    setProxyTestOk: 'Proxy joignable',
    setProxyTestFail: 'Proxy injoignable',
    setProxyPlaintextWarn:
      'Le chiffrement OS est indisponible ; le mot de passe est stocké en clair dans le dossier userData de l’app.',
    setSecIntegrations: 'Intégrations',
    intgHeroTitle: 'Utiliser AI Office depuis votre assistant IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quand une mise à jour de AI Office apporte un skill plus récent, un bouton Mettre à jour apparaît à côté de cet assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Choisissez son dossier skills et AI Office y écrit le fichier.',
    ...
    intgExample3: 'Convertis budget.xlsx en PDF et ouvre-le dans AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP est le protocole commun que les assistants IA utilisent pour appeler des outils externes. Utilisez-le si votre assistant ne peut pas lancer de commandes (Claude Desktop, par exemple) ou si vous voulez qu’il pilote directement la fenêtre AI Office. Choisissez l’une des deux méthodes ci-dessous.',
    intgMcpStdioTitle: 'Lancé par l’assistant (recommandé)',
    intgMcpStdioDesc:
      'L’assistant lance lui-même genoffice mcp : rien à activer ici, et AI Office n’a pas besoin d’être ouvert. Mêmes fonctions que la CLI.',
    intgMcpHttpTitle: 'Serveur HTTP local',
    intgMcpHttpDesc:
      'Tourne dans AI Office ; l’assistant se connecte à une URL et vous voyez le document se construire pas à pas dans l’éditeur Word. AI Office doit rester ouvert ; documents Word uniquement pour l’instant.',
    intgMcpHttpAdvanced: 'Avancé : autres adresses et journal',
    intgMcpTryNote: 'L’assistant appelle AI Office via MCP ; vous ne tapez jamais de commande.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copié',
    intgCliEphemeral:
      "Glissez d'abord AI Office dans Applications, puis utilisez la ligne de commande.",
    intgCopyPath: 'Copier le chemin',
    intgCliNeedsUpdate:
      'Ce skill requiert la ligne de commande {v} ou plus récente ; mettez AI Office à jour.',
    ...
    starPromptTitle: 'AI Office vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec AI Office',
    starPromptBody:
      'AI Office est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si AI Office vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans AI Office',
    ...
    onbBody2:
      'AI Office est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
  ...
  de: {
    ...
    setSecAbout: 'Über',
    setSecSystem: 'Dieser Computer',
    setSysComputerName: 'Computername',
    setSysHostname: 'Hostname',
    setSysOs: 'Betriebssystem',
    setSysArch: 'Architektur',
    setSysUser: 'Systembenutzer',
    setSysHome: 'Benutzerverzeichnis',
    setSysAppVersion: 'App-Version',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Systemsprache',
    setSysCpu: 'Prozessor',
    setSysMemory: 'Arbeitsspeicher',
    setSysCores: '{n} Kerne',
    setSysCopyAll: 'Alles kopieren',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Unternehmens-HTTP-Proxy einrichten. Der Benutzername stammt vom Systembenutzer dieses Computers. Das Passwort bleibt auf diesem Gerät.',
    setProxyEnabled: 'Proxy aktivieren',
    setProxyEnabledDesc:
      'Nach dem Speichern sofort für ausgehendes HTTP(S) des Hauptprozesses (KI, Bocha-Suche usw.).',
    setProxyUsername: 'Benutzername',
    setProxyUsernameHint:
      'Vorausgefüllt mit dem Systembenutzer dieses Computers. Bei Bedarf änderbar.',
    setProxyPassword: 'Passwort',
    setProxyPasswordHint: 'Wird weder in Git committed noch in Protokollen geschrieben.',
    setProxyHost: 'Host',
    setProxyPort: 'Port',
    setProxyUrl: 'Proxy-URL',
    setProxyUrlEmpty: 'Wird nach Benutzername und Passwort erzeugt',
    setProxyTestNeedCreds: 'Bitte zuerst Benutzername und Passwort eingeben',
    setProxyTestOk: 'Proxy erreichbar',
    setProxyTestFail: 'Proxy nicht erreichbar',
    setProxyPlaintextWarn:
      'OS-Verschlüsselung ist nicht verfügbar; das Passwort wird im Klartext im userData-Ordner gespeichert.',
    setSecIntegrations: 'Integrationen',
    intgHeroTitle: 'AI Office aus Ihrem KI-Assistenten nutzen',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Bringt ein AI Office-Update einen neueren Skill mit, erscheint neben diesem Assistenten ein Aktualisieren-Button.',
    intgSkillVersion: 'Skill {v}',
    ...
    intgOtherFolderDesc:
      'Wählen Sie seinen Skills-Ordner, und AI Office schreibt die Datei dorthin.',
    ...
    intgExample3: 'Wandle budget.xlsx in PDF um und öffne es in AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ist das gemeinsame Protokoll, über das KI-Assistenten externe Werkzeuge aufrufen. Nutzen Sie es, wenn der Assistent keine Befehle ausführen kann (z. B. Claude Desktop) oder wenn er das AI Office-Fenster direkt steuern soll. Wählen Sie einen der beiden Wege unten.',
    intgMcpStdioTitle: 'Vom Assistenten gestartet (empfohlen)',
    intgMcpStdioDesc:
      'Der Assistent startet genoffice mcp selbst: hier ist nichts einzuschalten, und AI Office muss nicht geöffnet sein. Gleicher Funktionsumfang wie die CLI.',
    intgMcpHttpTitle: 'Lokaler HTTP-Server',
    intgMcpHttpDesc:
      'Läuft in AI Office; der Assistent verbindet sich über eine URL, und Sie sehen im Word-Editor zu, wie das Dokument Schritt für Schritt entsteht. AI Office muss geöffnet bleiben; derzeit nur Word-Dokumente.',
    intgMcpHttpAdvanced: 'Erweitert: weitere Adressen und Protokoll',
    intgMcpTryNote: 'Der Assistent ruft AI Office über MCP auf; Sie tippen nie einen Befehl.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Kopiert',
    intgCliEphemeral:
      'Ziehen Sie AI Office zuerst in „Programme“, dann nutzen Sie die Befehlszeile.',
    intgCopyPath: 'Pfad kopieren',
    intgCliNeedsUpdate:
      'Dieser Skill braucht Befehlszeile {v} oder neuer; aktualisieren Sie AI Office.',
    intgLoading: 'Prüfe …',
    ...
    starPromptTitle: 'Gefällt Ihnen AI Office?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit AI Office geöffnet',
    starPromptBody:
      'AI Office ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen AI Office gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei AI Office',
    ...
    onbBody2:
      'AI Office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    setSecSystem: 'Este equipo',
    setSysComputerName: 'Nombre del equipo',
    setSysHostname: 'Nombre de host',
    setSysOs: 'Sistema operativo',
    setSysArch: 'Arquitectura',
    setSysUser: 'Usuario del sistema',
    setSysHome: 'Carpeta de usuario',
    setSysAppVersion: 'Versión de la aplicación',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Idioma del sistema',
    setSysCpu: 'Procesador',
    setSysMemory: 'Memoria',
    setSysCores: '{n} núcleos',
    setSysCopyAll: 'Copiar todo',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Configura el proxy HTTP corporativo. El usuario es el del sistema de este equipo. La contraseña se queda en este equipo.',
    setProxyEnabled: 'Activar proxy',
    setProxyEnabledDesc:
      'Al guardar, se aplica de inmediato al HTTP(S) de salida del proceso principal (IA, búsqueda Bocha, etc.).',
    setProxyUsername: 'Usuario',
    setProxyUsernameHint: 'Se rellena con el usuario del sistema de este equipo. Puedes cambiarlo.',
    setProxyPassword: 'Contraseña',
    setProxyPasswordHint: 'No se incluye en git ni se escribe en los registros.',
    setProxyHost: 'Host',
    setProxyPort: 'Puerto',
    setProxyUrl: 'URL del proxy',
    setProxyUrlEmpty: 'Se genera tras introducir usuario y contraseña',
    setProxyTestNeedCreds: 'Introduce primero un usuario y una contraseña',
    setProxyTestOk: 'Proxy accesible',
    setProxyTestFail: 'Proxy inaccesible',
    setProxyPlaintextWarn:
      'El cifrado del sistema no está disponible; la contraseña se guarda en texto plano en la carpeta userData.',
    setSecIntegrations: 'Integraciones',
    intgHeroTitle: 'Usa AI Office desde tu asistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Cuando una actualización de AI Office traiga un skill más nuevo, aparecerá un botón Actualizar junto a ese asistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Elige su carpeta de skills y AI Office escribe el archivo ahí.',
    ...
    intgExample3: 'Convierte budget.xlsx a PDF y ábrelo en AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP es el protocolo común con el que los asistentes de IA llaman a herramientas externas. Úsalo cuando tu asistente no pueda ejecutar comandos (Claude Desktop, por ejemplo) o cuando quieras que controle directamente la ventana de AI Office. Elige una de las dos formas de abajo.',
    intgMcpStdioTitle: 'Iniciado por el asistente (recomendado)',
    intgMcpStdioDesc:
      'El asistente lanza genoffice mcp por sí mismo: nada que activar aquí, y AI Office no necesita estar abierto. Mismas funciones que la CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Se ejecuta dentro de AI Office; el asistente se conecta a una URL y puedes ver cómo construye el documento paso a paso en el editor de Word. AI Office debe permanecer abierto; por ahora solo documentos Word.',
    intgMcpHttpAdvanced: 'Avanzado: otras direcciones y registro',
    intgMcpTryNote: 'El asistente llama a AI Office a través de MCP; nunca escribes un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral: 'Arrastra primero AI Office a Aplicaciones y luego usa la línea de comandos.',
    intgCopyPath: 'Copiar ruta',
    intgCliNeedsUpdate:
      'Este skill necesita la línea de comandos {v} o superior; actualiza AI Office.',
    ...
    starPromptTitle: '¿Te gusta AI Office?',
    starPromptTitleN: 'Has abierto {n} documentos con AI Office',
    starPromptBody:
      'AI Office es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta AI Office, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a AI Office',
    ...
    onbBody2:
      'AI Office aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
  ...
  th: {
    ...
    setSecSystem: 'คอมพิวเตอร์เครื่องนี้',
    setSysComputerName: 'ชื่อคอมพิวเตอร์',
    setSysHostname: 'ชื่อโฮสต์',
    setSysOs: 'ระบบปฏิบัติการ',
    setSysArch: 'สถาปัตยกรรม',
    setSysUser: 'ผู้ใช้ระบบ',
    setSysHome: 'โฮมไดเรกทอรี',
    setSysAppVersion: 'เวอร์ชันแอป',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'ภาษาของระบบ',
    setSysCpu: 'โปรเซสเซอร์',
    setSysMemory: 'หน่วยความจำ',
    setSysCores: '{n} คอร์',
    setSysCopyAll: 'คัดลอกทั้งหมด',
    setSecProxy: 'พร็อกซี',
    setProxyDesc:
      'ตั้งค่าพร็อกซี HTTP ขององค์กร ชื่อผู้ใช้เริ่มต้นเป็นผู้ใช้ระบบของเครื่องนี้ รหัสผ่านเก็บไว้ในเครื่องนี้เท่านั้น',
    setProxyEnabled: 'เปิดใช้พร็อกซี',
    setProxyEnabledDesc:
      'หลังบันทึก จะใช้ทันทีกับ HTTP(S) ขาออกของโปรเซสหลัก (AI, การค้นหา Bocha เป็นต้น)',
    setProxyUsername: 'ชื่อผู้ใช้',
    setProxyUsernameHint: 'เติมจากผู้ใช้ระบบของเครื่องนี้ สามารถเปลี่ยนได้',
    setProxyPassword: 'รหัสผ่าน',
    setProxyPasswordHint: 'ไม่ถูกคอมมิตเข้า git และไม่ถูกเขียนลงบันทึก',
    setProxyHost: 'โฮสต์',
    setProxyPort: 'พอร์ต',
    setProxyUrl: 'URL พร็อกซี',
    setProxyUrlEmpty: 'จะสร้างหลังจากกรอกชื่อผู้ใช้และรหัสผ่าน',
    setProxyTestNeedCreds: 'กรอกชื่อผู้ใช้และรหัสผ่านก่อน',
    setProxyTestOk: 'เชื่อมต่อพร็อกซีได้',
    setProxyTestFail: 'เชื่อมต่อพร็อกซีไม่ได้',
    setProxyPlaintextWarn:
      'ไม่สามารถใช้การเข้ารหัสของระบบได้ รหัสผ่านจะถูกเก็บเป็นข้อความธรรมดาในโฟลเดอร์ userData',
    setSecIntegrations: 'การเชื่อมต่อ',
    intgHeroTitle: 'ใช้ AI Office จากผู้ช่วย AI ของคุณ',
    intgHeroDesc:
    ...
    intgStep1Update:
      'เมื่อการอัปเดต AI Office มาพร้อมสกิลเวอร์ชันใหม่ ปุ่มอัปเดตจะปรากฏข้างผู้ช่วยนั้น',
    ...
    intgOtherFolderDesc: 'เลือกโฟลเดอร์ skills ของผู้ช่วย แล้ว AI Office จะเขียนไฟล์ลงไป',
    ...
    intgExample3: 'แปลง budget.xlsx เป็น PDF แล้วเปิดใน AI Office',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP คือโปรโตคอลกลางที่ผู้ช่วย AI ใช้เรียกเครื่องมือภายนอก ใช้เมื่อผู้ช่วยรันคำสั่งไม่ได้ (เช่น Claude Desktop) หรือเมื่อต้องการให้มันควบคุมหน้าต่าง AI Office โดยตรง เลือกวิธีใดวิธีหนึ่งจากสองวิธีด้านล่าง',
    intgMcpStdioTitle: 'ให้ผู้ช่วยเป็นผู้เริ่ม (แนะนำ)',
    intgMcpStdioDesc:
      'ผู้ช่วยจะเรียก genoffice mcp ขึ้นมาเอง ไม่ต้องเปิดสวิตช์ใดที่นี่ และไม่ต้องเปิด AI Office ไว้ ความสามารถเหมือน CLI ทุกประการ',
    intgMcpHttpTitle: 'เซิร์ฟเวอร์ HTTP ในเครื่อง',
    intgMcpHttpDesc:
      'ทำงานอยู่ใน AI Office ผู้ช่วยเชื่อมต่อผ่าน URL และคุณจะเห็นเอกสารค่อย ๆ ถูกสร้างขึ้นในตัวแก้ไข Word ต้องเปิด AI Office ไว้ตลอด ปัจจุบันรองรับเฉพาะ Word',
    intgMcpHttpAdvanced: 'ขั้นสูง: ที่อยู่อื่นและบันทึก',
    intgMcpTryNote: 'ผู้ช่วยจะเรียก AI Office ผ่าน MCP คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'กรุณาลาก AI Office ไปที่ Applications ก่อน แล้วจึงใช้บรรทัดคำสั่ง',
    intgCopyPath: 'คัดลอกพาธ',
    intgCliNeedsUpdate: 'สกิลนี้ต้องใช้บรรทัดคำสั่ง {v} หรือใหม่กว่า โปรดอัปเดต AI Office',
    ...
    starPromptTitle: 'ชอบ AI Office ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย AI Office ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'AI Office ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ AI Office ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ AI Office',
    ...
    onbBody2:
      'AI Office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
  ...
  id: {
    ...
    setSecAbout: 'Tentang',
    setSecSystem: 'Komputer ini',
    setSysComputerName: 'Nama komputer',
    setSysHostname: 'Nama host',
    setSysOs: 'Sistem operasi',
    setSysArch: 'Arsitektur',
    setSysUser: 'Pengguna sistem',
    setSysHome: 'Direktori home',
    setSysAppVersion: 'Versi aplikasi',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Bahasa sistem',
    setSysCpu: 'Prosesor',
    setSysMemory: 'Memori',
    setSysCores: '{n} inti',
    setSysCopyAll: 'Salin semua',
    setSecProxy: 'Proksi',
    setProxyDesc:
      'Atur proksi HTTP perusahaan. Nama pengguna default-nya adalah pengguna sistem komputer ini. Kata sandi hanya disimpan di mesin ini.',
    setProxyEnabled: 'Aktifkan proksi',
    setProxyEnabledDesc:
      'Setelah disimpan, langsung dipakai untuk HTTP(S) keluar proses utama (AI, pencarian Bocha, dll.).',
    setProxyUsername: 'Nama pengguna',
    setProxyUsernameHint: 'Diisi dari pengguna sistem komputer ini. Bisa diubah jika perlu.',
    setProxyPassword: 'Kata sandi',
    setProxyPasswordHint: 'Tidak pernah di-commit ke git dan tidak ditulis ke log.',
    setProxyHost: 'Host',
    setProxyPort: 'Port',
    setProxyUrl: 'URL proksi',
    setProxyUrlEmpty: 'Dibuat setelah nama pengguna dan kata sandi diisi',
    setProxyTestNeedCreds: 'Isi nama pengguna dan kata sandi terlebih dahulu',
    setProxyTestOk: 'Proksi dapat dijangkau',
    setProxyTestFail: 'Proksi tidak dapat dijangkau',
    setProxyPlaintextWarn:
      'Enkripsi OS tidak tersedia; kata sandi disimpan sebagai teks biasa di folder userData aplikasi.',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan AI Office dari asisten AI Anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Saat pembaruan AI Office membawa skill yang lebih baru, tombol Perbarui muncul di samping asisten itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills-nya dan AI Office menulis file di sana.',
    ...
    intgExample3: 'Konversi budget.xlsx ke PDF dan buka di AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP adalah protokol umum yang dipakai asisten AI untuk memanggil alat eksternal. Gunakan saat asisten Anda tidak bisa menjalankan perintah (misalnya Claude Desktop) atau saat Anda ingin ia mengendalikan jendela AI Office secara langsung. Pilih salah satu dari dua cara di bawah.',
    intgMcpStdioTitle: 'Dijalankan oleh asisten (disarankan)',
    intgMcpStdioDesc:
      'Asisten menjalankan genoffice mcp sendiri: tidak ada yang perlu dinyalakan di sini, dan AI Office tidak perlu terbuka. Fitur sama dengan CLI.',
    intgMcpHttpTitle: 'Server HTTP lokal',
    intgMcpHttpDesc:
      'Berjalan di dalam AI Office; asisten terhubung lewat URL dan Anda bisa melihat dokumen dibangun langkah demi langkah di editor Word. AI Office harus tetap terbuka; untuk saat ini hanya dokumen Word.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote: 'Asisten memanggil AI Office melalui MCP; Anda tidak pernah mengetik perintah.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret AI Office ke Applications dulu, lalu gunakan baris perintah.',
    intgCopyPath: 'Salin path',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris perintah {v} atau lebih baru; perbarui AI Office.',
    ...
    starPromptTitle: 'Suka AI Office?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan AI Office',
    starPromptBody:
      'AI Office gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai AI Office, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di AI Office',
    ...
    onbBody2:
      'AI Office masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
  ...
  ru: {
    ...
    setSecSystem: 'Этот компьютер',
    setSysComputerName: 'Имя компьютера',
    setSysHostname: 'Имя хоста',
    setSysOs: 'Операционная система',
    setSysArch: 'Архитектура',
    setSysUser: 'Системный пользователь',
    setSysHome: 'Домашняя папка',
    setSysAppVersion: 'Версия приложения',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Язык системы',
    setSysCpu: 'Процессор',
    setSysMemory: 'Память',
    setSysCores: '{n} ядер',
    setSysCopyAll: 'Копировать всё',
    setSecProxy: 'Прокси',
    setProxyDesc:
      'Настройка корпоративного HTTP-прокси. Имя пользователя берётся из системной учётной записи этого компьютера. Пароль остаётся на этом устройстве.',
    setProxyEnabled: 'Включить прокси',
    setProxyEnabledDesc:
      'После сохранения сразу применяется к исходящему HTTP(S) главного процесса (ИИ, поиск Bocha и т. п.).',
    setProxyUsername: 'Имя пользователя',
    setProxyUsernameHint: 'Подставляется системный пользователь этого компьютера. Можно изменить.',
    setProxyPassword: 'Пароль',
    setProxyPasswordHint: 'Не попадает в git и не пишется в журналы.',
    setProxyHost: 'Хост',
    setProxyPort: 'Порт',
    setProxyUrl: 'URL прокси',
    setProxyUrlEmpty: 'Появится после ввода имени пользователя и пароля',
    setProxyTestNeedCreds: 'Сначала введите имя пользователя и пароль',
    setProxyTestOk: 'Прокси доступен',
    setProxyTestFail: 'Прокси недоступен',
    setProxyPlaintextWarn:
      'Шифрование ОС недоступно; пароль хранится открытым текстом в папке userData приложения.',
    setSecIntegrations: 'Интеграции',
    intgHeroTitle: 'Используйте AI Office из своего ИИ-ассистента',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Когда обновление AI Office принесёт более новый скилл, рядом с этим ассистентом появится кнопка «Обновить».',
    ...
    intgOtherFolderDesc: 'Выберите его папку skills, и AI Office запишет файл туда.',
    ...
    intgExample3: 'Конвертируй budget.xlsx в PDF и открой в AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP — общий протокол, через который ИИ-ассистенты вызывают внешние инструменты. Используйте его, если ассистент не умеет выполнять команды (например, Claude Desktop) или если хотите, чтобы он напрямую управлял окном AI Office. Выберите один из двух способов ниже.',
    intgMcpStdioTitle: 'Запускает ассистент (рекомендуется)',
    intgMcpStdioDesc:
      'Ассистент сам запускает genoffice mcp: здесь ничего включать не нужно, и AI Office не обязан быть открыт. Те же возможности, что у CLI.',
    intgMcpHttpTitle: 'Локальный HTTP-сервер',
    intgMcpHttpDesc:
      'Работает внутри AI Office; ассистент подключается по URL, и вы видите, как документ шаг за шагом собирается в редакторе Word. AI Office должен оставаться открытым; пока только документы Word.',
    intgMcpHttpAdvanced: 'Дополнительно: другие адреса и журнал',
    intgMcpTryNote: 'Ассистент обращается к AI Office через MCP; вам не нужно вводить команды.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral:
      'Сначала перетащите AI Office в «Программы», затем используйте командную строку.',
    intgCopyPath: 'Копировать путь',
    intgCliNeedsUpdate: 'Этому скиллу нужна командная строка {v} или новее; обновите AI Office.',
    ...
    starPromptTitle: 'Нравится AI Office?',
    starPromptTitleN: 'Вы уже открыли {n} документов в AI Office',
    starPromptBody:
      'AI Office — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится AI Office, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в AI Office',
    ...
    onbBody2:
      'AI Office пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
  ...
  ar: {
    ...
    setSecAbout: 'حول',
    setSecSystem: 'هذا الكمبيوتر',
    setSysComputerName: 'اسم الكمبيوتر',
    setSysHostname: 'اسم المضيف',
    setSysOs: 'نظام التشغيل',
    setSysArch: 'المعمارية',
    setSysUser: 'مستخدم النظام',
    setSysHome: 'المجلد الرئيسي',
    setSysAppVersion: 'إصدار التطبيق',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'لغة النظام',
    setSysCpu: 'المعالج',
    setSysMemory: 'الذاكرة',
    setSysCores: '{n} أنوية',
    setSysCopyAll: 'نسخ الكل',
    setSecProxy: 'الوكيل',
    setProxyDesc:
      'إعداد وكيل HTTP للشركة. اسم المستخدم الافتراضي هو مستخدم نظام هذا الجهاز. تبقى كلمة المرور على هذا الجهاز.',
    setProxyEnabled: 'تفعيل الوكيل',
    setProxyEnabledDesc:
      'بعد الحفظ يُطبَّق فورًا على HTTP(S) الصادر من العملية الرئيسية (الذكاء الاصطناعي وبحث Bocha وغيرها).',
    setProxyUsername: 'اسم المستخدم',
    setProxyUsernameHint: 'يُملأ من مستخدم نظام هذا الجهاز. يمكن تغييره عند الحاجة.',
    setProxyPassword: 'كلمة المرور',
    setProxyPasswordHint: 'لا تُحفظ في git ولا تُكتب في السجلات.',
    setProxyHost: 'المضيف',
    setProxyPort: 'المنفذ',
    setProxyUrl: 'عنوان الوكيل',
    setProxyUrlEmpty: 'يُنشأ بعد إدخال اسم المستخدم وكلمة المرور',
    setProxyTestNeedCreds: 'أدخل اسم المستخدم وكلمة المرور أولًا',
    setProxyTestOk: 'الوكيل متاح',
    setProxyTestFail: 'تعذر الوصول إلى الوكيل',
    setProxyPlaintextWarn:
      'تعذر استخدام تشفير نظام التشغيل؛ تُحفظ كلمة المرور كنص واضح في مجلد userData.',
    setSecIntegrations: 'التكاملات',
    intgHeroTitle: 'استخدم AI Office من مساعد الذكاء الاصطناعي',
    intgHeroDesc:
    ...
    intgStep1Update: 'عندما يجلب تحديث AI Office مهارة أحدث، يظهر زر «تحديث» بجوار ذلك المساعد.',
    ...
    intgOtherFolderDesc: 'اختر مجلد skills الخاص به وسيكتب AI Office الملف هناك.',
    ...
    intgExample3: 'حوّل budget.xlsx إلى PDF وافتحه في AI Office',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP هو البروتوكول المشترك الذي يستخدمه مساعدو الذكاء الاصطناعي لاستدعاء أدوات خارجية. استخدمه إذا كان مساعدك لا يستطيع تنفيذ الأوامر (مثل Claude Desktop) أو إذا أردت أن يتحكم في نافذة AI Office مباشرة. اختر إحدى الطريقتين أدناه.',
    intgMcpStdioTitle: 'يشغّله المساعد (موصى به)',
    intgMcpStdioDesc:
      'يشغّل المساعد genoffice mcp بنفسه: لا شيء لتفعيله هنا، ولا يلزم أن يكون AI Office مفتوحًا. نفس إمكانات CLI.',
    intgMcpHttpTitle: 'خادم HTTP محلي',
    intgMcpHttpDesc:
      'يعمل داخل AI Office؛ يتصل المساعد عبر عنوان URL ويمكنك مشاهدة المستند يُبنى خطوة بخطوة في محرر Word. يجب أن يبقى AI Office مفتوحًا؛ مستندات Word فقط حاليًا.',
    intgMcpHttpAdvanced: 'متقدم: عناوين أخرى والسجل',
    intgMcpTryNote: 'يستدعي المساعد AI Office عبر MCP؛ لن تكتب أي أمر.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'تم النسخ',
    intgCliEphemeral: 'اسحب AI Office إلى مجلد التطبيقات أولاً، ثم استخدم سطر الأوامر.',
    intgCopyPath: 'نسخ المسار',
    intgCliNeedsUpdate: 'تحتاج هذه المهارة إلى سطر الأوامر {v} أو أحدث؛ حدّث AI Office.',
    ...
    starPromptTitle: 'هل أعجبك AI Office؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في AI Office',
    starPromptBody: 'AI Office مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك AI Office، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في AI Office',
    ...
    onbBody2:
      'لا يزال AI Office في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
  ...
  pt: {
    ...
    setSecAbout: 'Sobre',
    setSecSystem: 'Este computador',
    setSysComputerName: 'Nome do computador',
    setSysHostname: 'Nome do host',
    setSysOs: 'Sistema operacional',
    setSysArch: 'Arquitetura',
    setSysUser: 'Usuário do sistema',
    setSysHome: 'Pasta pessoal',
    setSysAppVersion: 'Versão do aplicativo',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Idioma do sistema',
    setSysCpu: 'Processador',
    setSysMemory: 'Memória',
    setSysCores: '{n} núcleos',
    setSysCopyAll: 'Copiar tudo',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Configure o proxy HTTP corporativo. O usuário padrão é o usuário do sistema deste computador. A senha fica neste aparelho.',
    setProxyEnabled: 'Ativar proxy',
    setProxyEnabledDesc:
      'Ao salvar, aplica-se imediatamente ao HTTP(S) de saída do processo principal (IA, busca Bocha etc.).',
    setProxyUsername: 'Usuário',
    setProxyUsernameHint:
      'Preenchido com o usuário do sistema deste computador. Pode ser alterado.',
    setProxyPassword: 'Senha',
    setProxyPasswordHint: 'Nunca vai para o git nem é gravada nos logs.',
    setProxyHost: 'Host',
    setProxyPort: 'Porta',
    setProxyUrl: 'URL do proxy',
    setProxyUrlEmpty: 'Gerada após informar usuário e senha',
    setProxyTestNeedCreds: 'Informe primeiro um usuário e uma senha',
    setProxyTestOk: 'Proxy acessível',
    setProxyTestFail: 'Proxy inacessível',
    setProxyPlaintextWarn:
      'A criptografia do SO está indisponível; a senha é armazenada em texto simples na pasta userData.',
    setSecIntegrations: 'Integrações',
    intgHeroTitle: 'Use o AI Office a partir do seu assistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quando uma atualização do AI Office trouxer um skill mais novo, um botão Atualizar aparece ao lado desse assistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Escolha a pasta de skills dele e o AI Office grava o arquivo lá.',
    ...
    intgExample3: 'Converta budget.xlsx para PDF e abra no AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP é o protocolo comum que assistentes de IA usam para chamar ferramentas externas. Use-o quando o assistente não puder executar comandos (Claude Desktop, por exemplo) ou quando quiser que ele controle a janela do AI Office diretamente. Escolha uma das duas formas abaixo.',
    intgMcpStdioTitle: 'Iniciado pelo assistente (recomendado)',
    intgMcpStdioDesc:
      'O assistente inicia o genoffice mcp sozinho: nada para ligar aqui, e o AI Office não precisa estar aberto. Mesmos recursos da CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Roda dentro do AI Office; o assistente conecta por URL e você acompanha o documento sendo montado passo a passo no editor Word. O AI Office precisa ficar aberto; por enquanto só documentos Word.',
    intgMcpHttpAdvanced: 'Avançado: outros endereços e log',
    intgMcpTryNote: 'O assistente chama o AI Office via MCP; você nunca digita um comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral:
      'Arraste o AI Office para Aplicativos primeiro e depois use a linha de comando.',
    intgCopyPath: 'Copiar caminho',
    intgCliNeedsUpdate:
      'Este skill precisa da linha de comando {v} ou mais recente; atualize o AI Office.',
    ...
    starPromptTitle: 'Gostando do AI Office?',
    starPromptTitleN: 'Você já abriu {n} documentos com o AI Office',
    starPromptBody:
      'O AI Office é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do AI Office, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao AI Office',
    ...
    onbBody2:
      'O AI Office ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
  ...
  it: {
    ...
    setSecSystem: 'Questo computer',
    setSysComputerName: 'Nome del computer',
    setSysHostname: 'Nome host',
    setSysOs: 'Sistema operativo',
    setSysArch: 'Architettura',
    setSysUser: 'Utente di sistema',
    setSysHome: 'Cartella home',
    setSysAppVersion: 'Versione dell’app',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Lingua di sistema',
    setSysCpu: 'Processore',
    setSysMemory: 'Memoria',
    setSysCores: '{n} core',
    setSysCopyAll: 'Copia tutto',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Configura il proxy HTTP aziendale. Il nome utente predefinito è l’utente di sistema di questo computer. La password resta su questo dispositivo.',
    setProxyEnabled: 'Abilita proxy',
    setProxyEnabledDesc:
      'Dopo il salvataggio si applica subito all’HTTP(S) in uscita del processo principale (IA, ricerca Bocha, ecc.).',
    setProxyUsername: 'Nome utente',
    setProxyUsernameHint:
      'Compilato con l’utente di sistema di questo computer. Modificabile se serve.',
    setProxyPassword: 'Password',
    setProxyPasswordHint: 'Non viene mai committata su git né scritta nei log.',
    setProxyHost: 'Host',
    setProxyPort: 'Porta',
    setProxyUrl: 'URL del proxy',
    setProxyUrlEmpty: 'Generato dopo nome utente e password',
    setProxyTestNeedCreds: 'Inserisci prima nome utente e password',
    setProxyTestOk: 'Proxy raggiungibile',
    setProxyTestFail: 'Proxy non raggiungibile',
    setProxyPlaintextWarn:
      'La cifratura del sistema non è disponibile; la password è salvata in chiaro nella cartella userData.',
    setSecIntegrations: 'Integrazioni',
    intgHeroTitle: 'Usa AI Office dal tuo assistente IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      "Quando un aggiornamento di AI Office porta uno skill più recente, accanto a quell'assistente compare un pulsante Aggiorna.",
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Scegli la sua cartella skills e AI Office vi scrive il file.',
    ...
    intgExample3: 'Converti budget.xlsx in PDF e aprilo in AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP è il protocollo comune con cui gli assistenti IA richiamano strumenti esterni. Usalo quando l’assistente non può eseguire comandi (Claude Desktop, ad esempio) o quando vuoi che controlli direttamente la finestra di AI Office. Scegli uno dei due modi qui sotto.',
    intgMcpStdioTitle: 'Avviato dall’assistente (consigliato)',
    intgMcpStdioDesc:
      'L’assistente avvia genoffice mcp da sé: niente da attivare qui, e AI Office non deve essere aperto. Stesse funzioni della CLI.',
    intgMcpHttpTitle: 'Server HTTP locale',
    intgMcpHttpDesc:
      'Gira dentro AI Office; l’assistente si collega a un URL e puoi vedere il documento prendere forma passo dopo passo nell’editor Word. AI Office deve restare aperto; per ora solo documenti Word.',
    intgMcpHttpAdvanced: 'Avanzato: altri indirizzi e registro',
    intgMcpTryNote: 'L’assistente richiama AI Office tramite MCP; non digiti mai un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'Copiato',
    intgCliEphemeral: 'Trascina prima AI Office in Applicazioni, poi usa la riga di comando.',
    intgCopyPath: 'Copia percorso',
    intgCliNeedsUpdate:
      'Questo skill richiede la riga di comando {v} o successiva; aggiorna AI Office.',
    ...
    starPromptTitle: 'Ti piace AI Office?',
    starPromptTitleN: 'Hai aperto {n} documenti con AI Office',
    starPromptBody:
      'AI Office è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace AI Office, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in AI Office',
    ...
    onbBody2:
      'AI Office è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
  ...
  pl: {
    ...
    setSecSystem: 'Ten komputer',
    setSysComputerName: 'Nazwa komputera',
    setSysHostname: 'Nazwa hosta',
    setSysOs: 'System operacyjny',
    setSysArch: 'Architektura',
    setSysUser: 'Użytkownik systemu',
    setSysHome: 'Katalog domowy',
    setSysAppVersion: 'Wersja aplikacji',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Język systemu',
    setSysCpu: 'Procesor',
    setSysMemory: 'Pamięć',
    setSysCores: '{n} rdzeni',
    setSysCopyAll: 'Kopiuj wszystko',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Skonfiguruj firmowe proxy HTTP. Domyślna nazwa użytkownika to konto systemowe tego komputera. Hasło zostaje na tym urządzeniu.',
    setProxyEnabled: 'Włącz proxy',
    setProxyEnabledDesc:
      'Po zapisaniu od razu dotyczy wychodzącego HTTP(S) procesu głównego (AI, wyszukiwanie Bocha itd.).',
    setProxyUsername: 'Nazwa użytkownika',
    setProxyUsernameHint: 'Wypełniana kontem systemowym tego komputera. Można zmienić.',
    setProxyPassword: 'Hasło',
    setProxyPasswordHint: 'Nie trafia do gita i nie jest zapisywane w logach.',
    setProxyHost: 'Host',
    setProxyPort: 'Port',
    setProxyUrl: 'Adres proxy',
    setProxyUrlEmpty: 'Powstanie po podaniu nazwy użytkownika i hasła',
    setProxyTestNeedCreds: 'Najpierw podaj nazwę użytkownika i hasło',
    setProxyTestOk: 'Proxy dostępne',
    setProxyTestFail: 'Proxy niedostępne',
    setProxyPlaintextWarn:
      'Szyfrowanie systemu jest niedostępne; hasło jest przechowywane jawnym tekstem w folderze userData.',
    setSecIntegrations: 'Integracje',
    intgHeroTitle: 'Używaj AI Office ze swojego asystenta AI',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Gdy aktualizacja AI Office przyniesie nowszy skill, obok tego asystenta pojawi się przycisk Aktualizuj.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Wybierz jego folder skills, a AI Office zapisze tam plik.',
    ...
    intgExample3: 'Przekonwertuj budget.xlsx do PDF i otwórz w AI Office',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP to wspólny protokół, którym asystenci AI wywołują zewnętrzne narzędzia. Użyj go, gdy asystent nie potrafi uruchamiać poleceń (np. Claude Desktop) lub gdy chcesz, aby bezpośrednio sterował oknem AI Office. Wybierz jeden z dwóch sposobów poniżej.',
    intgMcpStdioTitle: 'Uruchamiany przez asystenta (zalecane)',
    intgMcpStdioDesc:
      'Asystent sam uruchamia genoffice mcp: nic tu nie trzeba włączać, a AI Office nie musi być otwarty. Te same funkcje co CLI.',
    intgMcpHttpTitle: 'Lokalny serwer HTTP',
    intgMcpHttpDesc:
      'Działa wewnątrz AI Office; asystent łączy się przez URL, a Ty widzisz, jak dokument powstaje krok po kroku w edytorze Word. AI Office musi pozostać otwarty; na razie tylko dokumenty Word.',
    intgMcpHttpAdvanced: 'Zaawansowane: inne adresy i dziennik',
    intgMcpTryNote: 'Asystent wywołuje AI Office przez MCP; nigdy nie wpisujesz polecenia.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'Najpierw przenieś AI Office do Aplikacji, potem użyj wiersza poleceń.',
    intgCopyPath: 'Kopiuj ścieżkę',
    intgCliNeedsUpdate: 'Ten skill wymaga wiersza poleceń {v} lub nowszego; zaktualizuj AI Office.',
    ...
    starPromptTitle: 'Podoba Ci się AI Office?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w AI Office',
    starPromptBody:
      'AI Office jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się AI Office, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'AI Office jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
  ...
  cs: {
    ...
    setSecSystem: 'Tento počítač',
    setSysComputerName: 'Název počítače',
    setSysHostname: 'Název hostitele',
    setSysOs: 'Operační systém',
    setSysArch: 'Architektura',
    setSysUser: 'Systémový uživatel',
    setSysHome: 'Domovská složka',
    setSysAppVersion: 'Verze aplikace',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Jazyk systému',
    setSysCpu: 'Procesor',
    setSysMemory: 'Paměť',
    setSysCores: '{n} jader',
    setSysCopyAll: 'Kopírovat vše',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Nastavte firemní HTTP proxy. Výchozí uživatelské jméno je systémový účet tohoto počítače. Heslo zůstane v tomto zařízení.',
    setProxyEnabled: 'Povolit proxy',
    setProxyEnabledDesc:
      'Po uložení se hned použije na odchozí HTTP(S) hlavního procesu (AI, vyhledávání Bocha atd.).',
    setProxyUsername: 'Uživatelské jméno',
    setProxyUsernameHint: 'Předvyplněno systémovým uživatelem tohoto počítače. Lze změnit.',
    setProxyPassword: 'Heslo',
    setProxyPasswordHint: 'Nikdy se necommituje do gitu a nezapisuje se do logů.',
    setProxyHost: 'Hostitel',
    setProxyPort: 'Port',
    setProxyUrl: 'Adresa proxy',
    setProxyUrlEmpty: 'Vygeneruje se po zadání jména a hesla',
    setProxyTestNeedCreds: 'Nejprve zadejte uživatelské jméno a heslo',
    setProxyTestOk: 'Proxy je dostupné',
    setProxyTestFail: 'Proxy není dostupné',
    setProxyPlaintextWarn:
      'Šifrování OS není dostupné; heslo se ukládá v čitelné podobě ve složce userData.',
    setSecIntegrations: 'Integrace',
    intgHeroTitle: 'Používejte AI Office ze svého AI asistenta',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Když aktualizace AI Office přinese novější skill, u daného asistenta se objeví tlačítko Aktualizovat.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Vyberte jeho složku skills a AI Office tam soubor zapíše.',
    ...
    intgExample3: 'Převeď budget.xlsx do PDF a otevři ho v AI Office',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP je společný protokol, kterým AI asistenti volají externí nástroje. Použijte ho, když asistent neumí spouštět příkazy (např. Claude Desktop) nebo když chcete, aby přímo ovládal okno AI Office. Vyberte jeden ze dvou způsobů níže.',
    intgMcpStdioTitle: 'Spouští asistent (doporučeno)',
    intgMcpStdioDesc:
      'Asistent spustí genoffice mcp sám: tady není co zapínat a AI Office nemusí být otevřený. Stejné funkce jako CLI.',
    intgMcpHttpTitle: 'Místní HTTP server',
    intgMcpHttpDesc:
      'Běží uvnitř AI Office; asistent se připojí přes URL a v editoru Word sledujete, jak dokument krok za krokem vzniká. AI Office musí zůstat otevřený; zatím jen dokumenty Word.',
    intgMcpHttpAdvanced: 'Pokročilé: další adresy a protokol',
    intgMcpTryNote: 'Asistent volá AI Office přes MCP; žádný příkaz nepíšete.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'Nejprve přetáhněte AI Office do Aplikací a poté použijte příkazový řádek.',
    intgCopyPath: 'Kopírovat cestu',
    intgCliNeedsUpdate:
      'Tento skill vyžaduje příkazový řádek {v} nebo novější; aktualizujte AI Office.',
    ...
    starPromptTitle: 'Líbí se vám AI Office?',
    starPromptTitleN: 'V AI Office jste otevřeli už {n} dokumentů',
    starPromptBody:
      'AI Office je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám AI Office líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'AI Office je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
  ...
  nl: {
    ...
    setSecAbout: 'Over',
    setSecSystem: 'Deze computer',
    setSysComputerName: 'Computernaam',
    setSysHostname: 'Hostnaam',
    setSysOs: 'Besturingssysteem',
    setSysArch: 'Architectuur',
    setSysUser: 'Systeemgebruiker',
    setSysHome: 'Homemap',
    setSysAppVersion: 'App-versie',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Systeemtaal',
    setSysCpu: 'Processor',
    setSysMemory: 'Geheugen',
    setSysCores: '{n} kernen',
    setSysCopyAll: 'Alles kopiëren',
    setSecProxy: 'Proxy',
    setProxyDesc:
      'Stel de zakelijke HTTP-proxy in. De gebruikersnaam is standaard de systeemgebruiker van deze computer. Het wachtwoord blijft op dit apparaat.',
    setProxyEnabled: 'Proxy inschakelen',
    setProxyEnabledDesc:
      'Na opslaan meteen van toepassing op uitgaand HTTP(S) van het hoofdproces (AI, Bocha-zoekopdrachten, enz.).',
    setProxyUsername: 'Gebruikersnaam',
    setProxyUsernameHint:
      'Ingevuld met de systeemgebruiker van deze computer. Indien nodig aanpasbaar.',
    setProxyPassword: 'Wachtwoord',
    setProxyPasswordHint: 'Wordt nooit naar git gecommit en nooit in logs geschreven.',
    setProxyHost: 'Host',
    setProxyPort: 'Poort',
    setProxyUrl: 'Proxy-URL',
    setProxyUrlEmpty: 'Wordt gegenereerd na gebruikersnaam en wachtwoord',
    setProxyTestNeedCreds: 'Voer eerst een gebruikersnaam en wachtwoord in',
    setProxyTestOk: 'Proxy bereikbaar',
    setProxyTestFail: 'Proxy onbereikbaar',
    setProxyPlaintextWarn:
      'OS-versleuteling is niet beschikbaar; het wachtwoord wordt als platte tekst in de userData-map bewaard.',
    setSecIntegrations: 'Integraties',
    intgHeroTitle: 'AI Office gebruiken vanuit uw AI-assistent',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Wanneer een AI Office-update een nieuwere skill meebrengt, verschijnt naast die assistent een knop Bijwerken.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Kies zijn skills-map en AI Office schrijft het bestand daar.',
    ...
    intgExample3: 'Zet budget.xlsx om naar PDF en open het in AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is het gemeenschappelijke protocol waarmee AI-assistenten externe tools aanroepen. Gebruik het als je assistent geen opdrachten kan uitvoeren (bijvoorbeeld Claude Desktop) of als je wilt dat hij het AI Office-venster rechtstreeks bestuurt. Kies een van de twee manieren hieronder.',
    intgMcpStdioTitle: 'Gestart door de assistent (aanbevolen)',
    intgMcpStdioDesc:
      'De assistent start genoffice mcp zelf: hier hoeft niets aan, en AI Office hoeft niet open te staan. Dezelfde functies als de CLI.',
    intgMcpHttpTitle: 'Lokale HTTP-server',
    intgMcpHttpDesc:
      'Draait in AI Office; de assistent verbindt via een URL en je ziet het document stap voor stap ontstaan in de Word-editor. AI Office moet open blijven; voorlopig alleen Word-documenten.',
    intgMcpHttpAdvanced: 'Geavanceerd: andere adressen en logboek',
    intgMcpTryNote: 'De assistent roept AI Office aan via MCP; je typt nooit een opdracht.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: "Sleep AI Office eerst naar Programma's en gebruik daarna de opdrachtregel.",
    intgCopyPath: 'Pad kopiëren',
    intgCliNeedsUpdate: 'Deze skill vereist opdrachtregel {v} of nieuwer; werk AI Office bij.',
    ...
    starPromptTitle: 'Bevalt AI Office?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met AI Office',
    starPromptBody:
      'AI Office is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als AI Office je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij AI Office',
    ...
    onbBody2:
      'AI Office is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    setSecSystem: 'Komputer ini',
    setSysComputerName: 'Nama komputer',
    setSysHostname: 'Nama hos',
    setSysOs: 'Sistem pengendalian',
    setSysArch: 'Seni bina',
    setSysUser: 'Pengguna sistem',
    setSysHome: 'Direktori rumah',
    setSysAppVersion: 'Versi aplikasi',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'Bahasa sistem',
    ...
    setProxyPlaintextWarn:
      'Enkripsi OS tidak tersedia; kata sandi disimpan sebagai teks biasa di folder userData aplikasi.',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan AI Office daripada pembantu AI anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Apabila kemas kini AI Office membawa skill yang lebih baharu, butang Kemas kini muncul di sebelah pembantu itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills pembantu itu dan AI Office menulis fail di sana.',
    ...
    intgExample3: 'Tukar budget.xlsx kepada PDF dan buka dalam AI Office',
    intgStep2Note:
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ialah protokol umum yang digunakan pembantu AI untuk memanggil alat luaran. Gunakannya apabila pembantu anda tidak boleh menjalankan arahan (contohnya Claude Desktop) atau apabila anda mahu ia mengawal tetingkap AI Office secara langsung. Pilih salah satu daripada dua cara di bawah.',
    intgMcpStdioTitle: 'Dimulakan oleh pembantu (disyorkan)',
    intgMcpStdioDesc:
      'Pembantu melancarkan genoffice mcp sendiri: tiada apa yang perlu dihidupkan di sini, dan AI Office tidak perlu dibuka. Ciri sama seperti CLI.',
    intgMcpHttpTitle: 'Pelayan HTTP tempatan',
    intgMcpHttpDesc:
      'Berjalan di dalam AI Office; pembantu menyambung melalui URL dan anda boleh melihat dokumen dibina langkah demi langkah dalam editor Word. AI Office mesti kekal dibuka; buat masa ini dokumen Word sahaja.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote:
      'Pembantu memanggil AI Office melalui MCP; anda tidak perlu menaip sebarang arahan.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgSavedTo: 'Disimpan ke {path}',
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret AI Office ke Applications dahulu, kemudian gunakan baris arahan.',
    intgCopyPath: 'Salin laluan',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris arahan {v} atau lebih baharu; kemas kini AI Office.',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan AI Office',
    starPromptBody:
      'AI Office percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka AI Office, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke AI Office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'AI Office masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    setSecAbout: 'אודות',
    setSecSystem: 'מחשב זה',
    setSysComputerName: 'שם המחשב',
    setSysHostname: 'שם מארח',
    setSysOs: 'מערכת הפעלה',
    setSysArch: 'ארכיטקטורה',
    setSysUser: 'משתמש מערכת',
    setSysHome: 'תיקיית הבית',
    setSysAppVersion: 'גרסת האפליקציה',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'שפת המערכת',
    setSysCpu: 'מעבד',
    setSysMemory: 'זיכרון',
    setSysCores: '{n} ליבות',
    setSysCopyAll: 'העתק הכל',
    setSecProxy: 'פרוקסי',
    setProxyDesc:
      'הגדרת פרוקסי HTTP ארגוני. שם המשתמש כברירת מחדל הוא משתמש המערכת של המחשב. הסיסמה נשארת במכשיר זה.',
    setProxyEnabled: 'הפעל פרוקסי',
    setProxyEnabledDesc:
      'לאחר השמירה חל מיד על HTTP(S) יוצא של תהליך הראשי (AI, חיפוש Bocha וכו׳).',
    setProxyUsername: 'שם משתמש',
    setProxyUsernameHint: 'ממולא ממשתמש המערכת של מחשב זה. אפשר לשנות.',
    setProxyPassword: 'סיסמה',
    setProxyPasswordHint: 'לא נשמרת ב-git ולא נכתבת ביומנים.',
    setProxyHost: 'מארח',
    setProxyPort: 'פורט',
    setProxyUrl: 'כתובת פרוקסי',
    setProxyUrlEmpty: 'נוצרת אחרי הזנת שם משתמש וסיסמה',
    setProxyTestNeedCreds: 'יש להזין תחילה שם משתמש וסיסמה',
    setProxyTestOk: 'הפרוקסי זמין',
    setProxyTestFail: 'לא ניתן להגיע לפרוקסי',
    setProxyPlaintextWarn:
      'הצפנת מערכת ההפעלה אינה זמינה; הסיסמה נשמרת כטקסט גלוי בתיקיית userData.',
    setSecIntegrations: 'שילובים',
    intgHeroTitle: 'שימוש ב-AI Office מתוך עוזר ה-AI שלכם',
    intgHeroDesc:
    ...
    intgStep1Update: 'כשעדכון של AI Office מביא skill חדש יותר, ליד אותו עוזר יופיע כפתור עדכון.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'בחרו את תיקיית ה-skills שלו ו-AI Office יכתוב שם את הקובץ.',
    ...
    intgExample3: 'המר את budget.xlsx ל-PDF ופתח אותו ב-AI Office',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP הוא הפרוטוקול המשותף שבו עוזרי AI קוראים לכלים חיצוניים. השתמשו בו כשהעוזר אינו יכול להריץ פקודות (למשל Claude Desktop) או כשאתם רוצים שהוא ישלוט ישירות בחלון AI Office. בחרו אחת משתי הדרכים למטה.',
    intgMcpStdioTitle: 'מופעל על ידי העוזר (מומלץ)',
    intgMcpStdioDesc:
      'העוזר מפעיל את genoffice mcp בעצמו: אין מה להפעיל כאן, ו‑AI Office לא חייב להיות פתוח. אותן יכולות כמו ב‑CLI.',
    intgMcpHttpTitle: 'שרת HTTP מקומי',
    intgMcpHttpDesc:
      'פועל בתוך AI Office; העוזר מתחבר דרך כתובת URL ואפשר לראות את המסמך נבנה צעד אחר צעד בעורך Word. AI Office חייב להישאר פתוח; בשלב זה מסמכי Word בלבד.',
    intgMcpHttpAdvanced: 'מתקדם: כתובות נוספות ויומן',
    intgMcpTryNote: 'העוזר קורא ל‑AI Office דרך MCP; אתם לא מקלידים שום פקודה.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: 'הועתק',
    intgCliEphemeral: 'גררו קודם את AI Office לתיקיית היישומים, ואז השתמשו בשורת הפקודה.',
    intgCopyPath: 'העתקת נתיב',
    intgCliNeedsUpdate: 'skill זה דורש שורת פקודה {v} ומעלה; עדכנו את AI Office.',
    intgLoading: 'בודק…',
    ...
    starPromptTitle: 'נהנים מ-AI Office?',
    starPromptTitleN: 'פתחת {n} מסמכים עם AI Office',
    starPromptBody: 'AI Office חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם AI Office מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-AI Office',
    ...
    onbBody2:
      'AI Office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
  ...
  hi: {
    ...
    setSecAbout: 'जानकारी',
    setSecSystem: 'यह कंप्यूटर',
    setSysComputerName: 'कंप्यूटर का नाम',
    setSysHostname: 'होस्टनाम',
    setSysOs: 'ऑपरेटिंग सिस्टम',
    setSysArch: 'आर्किटेक्चर',
    setSysUser: 'सिस्टम उपयोगकर्ता',
    setSysHome: 'होम डायरेक्टरी',
    setSysAppVersion: 'ऐप संस्करण',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: 'सिस्टम भाषा',
    setSysCpu: 'प्रोसेसर',
    setSysMemory: 'मेमोरी',
    setSysCores: '{n} कोर',
    setSysCopyAll: 'सभी कॉपी करें',
    setSecProxy: 'प्रॉक्सी',
    setProxyDesc:
      'कॉर्पोरेट HTTP प्रॉक्सी सेट करें। उपयोगकर्ता नाम इस कंप्यूटर के सिस्टम यूज़र से आता है। पासवर्ड इसी मशीन पर रहता है।',
    setProxyEnabled: 'प्रॉक्सी चालू करें',
    setProxyEnabledDesc:
      'सेव करने के बाद मुख्य प्रोसेस के आउटबाउंड HTTP(S) (AI, Bocha खोज आदि) पर तुरंत लागू होता है।',
    setProxyUsername: 'उपयोगकर्ता नाम',
    setProxyUsernameHint: 'इस कंप्यूटर के सिस्टम यूज़र से भरा जाता है। ज़रूरत हो तो बदल सकते हैं।',
    setProxyPassword: 'पासवर्ड',
    setProxyPasswordHint: 'git में कमिट नहीं होता और लॉग में नहीं लिखा जाता।',
    setProxyHost: 'होस्ट',
    setProxyPort: 'पोर्ट',
    setProxyUrl: 'प्रॉक्सी URL',
    setProxyUrlEmpty: 'उपयोगकर्ता नाम और पासवर्ड भरने पर बनता है',
    setProxyTestNeedCreds: 'पहले उपयोगकर्ता नाम और पासवर्ड भरें',
    setProxyTestOk: 'प्रॉक्सी उपलब्ध',
    setProxyTestFail: 'प्रॉक्सी उपलब्ध नहीं',
    setProxyPlaintextWarn:
      'OS एन्क्रिप्शन उपलब्ध नहीं है; पासवर्ड ऐप के userData फ़ोल्डर में सादे पाठ के रूप में संग्रहीत है।',
    setSecIntegrations: 'इंटीग्रेशन',
    intgHeroTitle: 'अपने AI असिस्टेंट से AI Office इस्तेमाल करें',
    intgHeroDesc:
    ...
    intgStep1Update:
      'जब AI Office के अपडेट में नया skill आता है, तो उस असिस्टेंट के पास अपडेट बटन दिखता है।',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'उसका skills फ़ोल्डर चुनें, AI Office वहाँ फ़ाइल लिख देगा।',
    ...
    intgExample3: 'budget.xlsx को PDF में बदलो और AI Office में खोलो',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP वह साझा प्रोटोकॉल है जिससे AI सहायक बाहरी टूल बुलाते हैं। इसे तब चुनें जब सहायक कमांड न चला सके (जैसे Claude Desktop) या आप चाहें कि वह AI Office की विंडो को सीधे चलाए। नीचे दिए दो तरीकों में से कोई एक चुनें।',
    intgMcpStdioTitle: 'सहायक द्वारा शुरू (अनुशंसित)',
    intgMcpStdioDesc:
      'सहायक खुद genoffice mcp चलाता है: यहाँ कुछ चालू करने की ज़रूरत नहीं, और AI Office खुला होना भी ज़रूरी नहीं। सुविधाएँ CLI जैसी ही।',
    intgMcpHttpTitle: 'स्थानीय HTTP सर्वर',
    intgMcpHttpDesc:
      'AI Office के अंदर चलता है; सहायक URL से जुड़ता है और आप Word संपादक में दस्तावेज़ को चरण-दर-चरण बनते देख सकते हैं। AI Office खुला रहना चाहिए; अभी केवल Word दस्तावेज़।',
    intgMcpHttpAdvanced: 'उन्नत: अन्य पते और लॉग',
    intgMcpTryNote:
      'सहायक MCP के ज़रिये AI Office को बुलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliEphemeral: 'पहले AI Office को Applications में खींचें, फिर कमांड लाइन का उपयोग करें।',
    intgCopyPath: 'पथ कॉपी करें',
    intgCliNeedsUpdate: 'इस skill को कमांड लाइन {v} या नया चाहिए; AI Office अपडेट करें।',
    ...
    starPromptTitle: 'AI Office पसंद आ रहा है?',
    starPromptTitleN: 'आपने AI Office में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'AI Office मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको AI Office पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'AI Office में आपका स्वागत है',
    ...
    onbBody2:
      'AI Office अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
  ...
  'zh-TW': {
    ...
    setSecAbout: '關於',
    setSecSystem: '本機資訊',
    setSysComputerName: '電腦名稱',
    setSysHostname: '主機名稱',
    setSysOs: '作業系統',
    setSysArch: '架構',
    setSysUser: '系統使用者',
    setSysHome: '家目錄',
    setSysAppVersion: '應用程式版本',
    setSysElectron: 'Electron',
    setSysChrome: 'Chromium',
    setSysLocale: '系統語言',
    setSysCpu: '處理器',
    ...
    setSysCopyAll: '複製全部',
    setSecProxy: '網路代理',
    setProxyDesc: '設定企業 HTTP 代理。使用者名稱預設為本機系統使用者。密碼只保存在這台電腦。',
    setProxyEnabled: '啟用代理',
    setProxyEnabledDesc: '儲存後立即套用到本應用主行程的出站 HTTP(S)（AI、博查搜尋等）。',
    setProxyUsername: '使用者名稱',
    setProxyUsernameHint: '預設使用本機系統使用者，可依需要修改。',
    setProxyPassword: '密碼',
    setProxyPasswordHint: '不會寫入 git，也不會記錄到日誌。',
    setProxyHost: '主機',
    setProxyPort: '連接埠',
    setProxyUrl: '代理位址',
    setProxyUrlEmpty: '填寫使用者名稱和密碼後產生',
    setProxyTestNeedCreds: '請先填寫使用者名稱和密碼',
    setProxyTestOk: '代理可用',
    setProxyTestFail: '代理不可用',
    setProxyPlaintextWarn: '無法使用系統加密，密碼會以明文保存在應用程式 userData 目錄。',
    setSecIntegrations: '整合',
    intgHeroTitle: '在 AI 助理中使用 AI Office',
    intgHeroDesc:
    ...
    intgStep1Update: 'AI Office 升級帶來新版 skill 時，對應助理旁會出現「更新」按鈕。',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: '選擇它的 skills 資料夾，AI Office 會把檔案寫進去。',
    ...
    intgExample3: '把 budget.xlsx 轉成 PDF，並在 AI Office 中開啟',
    ...
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助理呼叫外部工具的通用協定。助理不能執行指令（如 Claude Desktop），或你想讓它直接操作 AI Office 視窗時用這條路。下面兩種接法任選一種。',
    intgMcpStdioTitle: '由助理啟動（建議）',
    intgMcpStdioDesc:
      '助理自己啟動 genoffice mcp，不需要在這裡開任何開關，AI Office 也不用開著。功能與 CLI 完全相同。',
    intgMcpHttpTitle: '本機 HTTP 服務',
    intgMcpHttpDesc:
      '在 AI Office 內執行，助理透過網址連線，可以看著它在 Word 編輯器裡逐步產生。需要 AI Office 保持開啟；目前只支援 Word。',
    intgMcpHttpAdvanced: '進階：其他位址與記錄',
    intgMcpTryNote: '助理會透過 MCP 呼叫 AI Office，你不需要輸入任何指令。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCopied: '已複製',
    intgCliEphemeral: '請先把 AI Office 拖到「應用程式」，再使用命令列。',
    intgCopyPath: '複製路徑',
    intgCliNeedsUpdate: '此 skill 需要命令列 {v} 或更新版本，請更新 AI Office。',
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    ...
    starPromptTitle: '喜歡 AI Office 嗎？',
    starPromptTitleN: '你已經用 AI Office 開啟了 {n} 個文件',
    starPromptBody: 'AI Office 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 AI Office，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 AI Office',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'AI Office 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
