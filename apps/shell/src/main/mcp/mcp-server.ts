...
/**
 * Local MCP server for AI Office.
 *
...
export class McpServerService {
  ...
  private createSessionServer(): McpServer {
    const server = new McpServer({ name: 'AI Office', version: this.version })
   ...
   * reads as a AI Office bug. Answers the JSON-RPC parse error itself and
