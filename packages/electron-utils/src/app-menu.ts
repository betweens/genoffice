...
const LABELS: Record<string, Labels> = {
  ...
  it: {
    ...
    help: 'Aiuto',
    about: 'Informazioni su AI Office',
...
export function aboutMenuItem(labels: AppMenuLabels): MenuItemConstructorOptions {
  return {
    ...
    click: async () => {
      ...
      if (response === 1) clipboard.writeText(`AI Office ${version}`)
